...
<p>&emsp;&lt;/navMap></p>
<p>&lt;/ncx><br> <hr><br>(If you wish, instead of '#toc1' and '#toc2', you can use '#chapter1' and '#chapter2', whatever your chapter anchors are in html file<br>Usually, id inside of 'h1' or 'h2' tag at the start of each chapter, or a single html or xhtml file for each chapter.<br>Single html file is used for the book content, instead of multiple xhtml files.)</p>
